...
db.execute("CREATE TABLE IF NOT EXISTS owned (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uuid INTEGER NOT NULL, symbol VARCHAR(255) NOT NULL, shares INTEGER NOT NULL, FOREIGN KEY (uuid) REFERENCES users(id));")
